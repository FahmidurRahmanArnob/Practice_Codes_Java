...
public class CodeChefStarters_31_AlternatingString {
    ...
    private static void solve() throws IOException{
        ...
        if(countZeros == countOnes){
            System.out.println(2 * Math.min(countZeros, countOnes));
        }
        else{
            System.out.println(2 * Math.min(countZeros, countOnes) + 1);
        }
    }
