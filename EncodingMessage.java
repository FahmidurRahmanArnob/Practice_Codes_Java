...
class EncodingMessage {
    ...
    private static void solve() throws IOException{
        ...
        for(int i=0;i<n;i++){
            char sh = 'z' + 'a';//'z' == 122 && 'a' == 97; by adding we are having a value;
            char sh2 = (char) (sh - s[i]);// and by subtracting that value by the value of the ith char we are getting the ASCII value of that char of which ith char should be exchange of;
            s[i] = sh2;// we are exchanging with that char;
            // 'z' + 'a' ==> 122 + 97 = 219 ;
            // now sh = 219 so sh = s[i] == 219 - 97(we consider s[i] == 'a') == 122
            // which is the ascii value of z
