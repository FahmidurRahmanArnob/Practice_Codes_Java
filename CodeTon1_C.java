...
public class CodeTon1_C {
    ...
    private static void solve() throws IOException{
        ...
        boolean trueOfFalse = false, anotherRandomVariable = false;
        for(int i=0;i<lenOfArray;i++){
            ...
            if(arr[i] == 1){
                anotherRandomVariable = true;
            }
        }
        if(trueOfFalse && anotherRandomVariable){
            System.out.println("NO");
        }
        else if(!anotherRandomVariable){
