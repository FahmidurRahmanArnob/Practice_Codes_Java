...
public class CodeforcesRound778_B {
    ...
    private static void solve() throws IOException{
        ...
        longRuffleSort(arr);
        boolean nCheck = n == 1;
        boolean nMinusOneGreaterThanOneCheck = arr[n - 1] > 1;
        boolean nMinusOneEqualToOneCheck = arr[n - 1] == 1;
        if(nCheck && nMinusOneGreaterThanOneCheck){
            System.out.println("NO");
        }
        else if(nCheck && nMinusOneEqualToOneCheck){
            System.out.println("YES");
        }
        else{
            long checkingNminusOneAndNminusTwo = arr[n - 1] - arr[n - 2];
            boolean ok = checkingNminusOneAndNminusTwo > 1;
            if(ok){
                System.out.println("NO");
            }
            else{
