...
class CodeChefStarters_32_BinaryStringCost {
    ...
    private static void solve() throws IOException{
        //Your Code Goes Here;
        int nOne = in.nextInt(), xOne = in.nextInt(), yOne = in.nextInt();
        char[] s = new char[nOne];
        ...
        if(count1 > 0 &&  count0 > 0) System.out.println(Math.min(xOne, yOne));
