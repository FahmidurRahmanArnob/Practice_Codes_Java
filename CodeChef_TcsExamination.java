...
class CodeChef_TcsExamination {
    ...
    private static void solve() throws IOException{
        //Your Code Goes Here;
        int dDsa = in.nextInt(), dToc = in.nextInt(), dDm = in.nextInt();
        int sDsa = in.nextInt(), sToc = in.nextInt(), sDm = in.nextInt();
        int dTotal = dDsa + dToc + dDm;
        int sTotal = sDsa + sToc + sDm;
        boolean totalIsEvenlyMatched = dTotal == sTotal;
        boolean dsaTotalIsEvenlyMatched = dDsa == sDsa;
        boolean tocIsEvenlyMatched = dToc == sToc;
        if(dTotal > sTotal) System.out.println("Dragon");
        else if(sTotal > dTotal) System.out.println("Sloth");
        else if(totalIsEvenlyMatched && dDsa > sDsa) System.out.println("DRAGON");
        else if(totalIsEvenlyMatched && sDsa > dDsa) System.out.println("SLOTH");
        else if(totalIsEvenlyMatched && dsaTotalIsEvenlyMatched && dToc > sToc) System.out.println("DRAGON");
        else if(totalIsEvenlyMatched && dsaTotalIsEvenlyMatched && sToc > dToc) System.out.println("SLOTH");
        else if(totalIsEvenlyMatched && dsaTotalIsEvenlyMatched && tocIsEvenlyMatched) System.out.println("TIE");
    }
