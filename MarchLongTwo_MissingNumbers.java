...
class MarchLongTwo_MissingNumbers {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(T-->0){
            ...
            if((OneA==0)&&ok1&&(OneB==0)&&okPart1)
            {
                ...
                int multi = (int) (a1 * b1);
                boolean boolA = a1 >= 1, boolB = b1 >= 1;
                if(((int)divide==(double)arr[1])&&(multi==(double)arr[3])&&boolA&&boolB&&(a1<=10000)&&(b1<=10000))
                {
            ...
            if((TwoA==0)&&ok2&&(TwoB==0)&&okPart2)
            {
                ...
                int multi = (int) (a2 * b2);
                boolean bool2A = a2 >= 1, bool2B = b2 >= 1;
                if(((long)divide==(double)arr[0])&&(multi==(double)arr[3])&&bool2A&&bool2B&&(a2<=10000)&&(b2<=10000))
                {
            ...
            if((ThreeA==0)&& ok3 &&(ThreeB==0)&&okPart3)
            {
                ...
                boolean bool3A = a3 >= 1, bool3B = b3 >= 1;
                if(((long)divide==(double)arr[1])&&(multi==(double)arr[2])&&bool3A&&bool3B&&(a3<=10000)&&(b3<=10000))
                {
            ...
            if((fourA==0)&&ok4&&(fourB==0)&&okPart4)
            {
                ...
                int multi = (int) (a4 * b4);
                boolean bool4A = a4 >= 1, bool4B = b4 >= 1;
                if(((long)divide==(double)arr[0])&&(multi==(double)arr[2])&&bool4A&&bool4B&&(a4<=10000)&&(b4<=10000))
                {
