...
public class CodeForces_Round_779_A {
...
//        int checkerOfAnswer = 0;
//        int okay = n - 1;
//        for(int i=0;i<okay;i++){
//            boolean thinkRight = i < n - 2;
//            if(s[i] == '0' && s[i + 1] == '0'){
//                checkerOfAnswer+=2;
//            }
//            else if(thinkRight && s[i] == '0' && s[i + 1] == '1' && s[i + 2] == '0'){
//                checkerOfAnswer++;
//            }
//        }
//        System.out.println(checkerOfAnswer);
        int n = in.nextInt();
        String s = in.next();
        int check = 0;
        int res = n - 1;
        for(int i=0;i<res;i++){
            boolean checker = i < n - 2;
            boolean sOfi = s.charAt(i) == '0';
            boolean sOfiPlusOne = s.charAt(i + 1) == '0';
            if(sOfi && sOfiPlusOne){
                check+=2;
            }
            else if(checker && s.charAt(i) == '0' && s.charAt(i + 1) == '1' && s.charAt(i + 2) == '0'){
                check++;
            }
        }
