...
class CodeChefStarters_32_VolumeControl {
    ...
    private static void solve() throws IOException{
        //Your Code Goes Here;
        int firstOne = in.nextInt(), secondOne = in.nextInt();
        boolean yes = firstOne > secondOne;
        int firstOutPut = firstOne - secondOne;
        int secondOutput = secondOne - firstOne;
        if(yes){
