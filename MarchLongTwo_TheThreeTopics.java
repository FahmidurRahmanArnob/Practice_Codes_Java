...
class MarchLongTwo_TheThreeTopics {
    ...
    private static void solve() throws IOException{
        //Your Code Goes Here;
        int firstTopic = in.nextInt(), secondTopic = in.nextInt(), thirdTopic = in.nextInt(), chefGot = in.nextInt();
        if(firstTopic == chefGot || secondTopic == chefGot || thirdTopic == chefGot){
