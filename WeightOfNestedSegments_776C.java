...
public class WeightOfNestedSegments_776C {
    ...
    private static void solve() throws IOException{
        ...
        int m = in.nextInt();
        for( int i = 0 ;i < m ;i++) {
            a.add(new pair(i+1 , in.nextInt() , in.nextInt()));
        }
        Collections.sort(a);
        ...
        out.println(sum);
        Collections.sort(b , new by_x());
        int i = 0;
        int j = 2*n-1;
        while( i < j) {
            out.println(b.get(i).i + " " + b.get(j).i);
            i++;
            j--;
        }
        //out.flush();
    ...
    private static class pair implements Comparable<pair>{
        ...
        @Override
        public int compareTo(WeightOfNestedSegments_776C.pair o){
            return this.val - o.val;
        }
    }

    private static class by_x implements Comparator<pair>{
