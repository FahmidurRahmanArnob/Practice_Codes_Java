...
//            int checkingMinimumElement = arr[0];
//            int gettingMinimumIndex = 0;
//            int checkingMaximumElement = arr[0];
//            int gettingMaximumIndex = 0;
//            for(int i=0;i<n;i++){
//                if(arr[i] < checkingMinimumElement){
//                    checkingMinimumElement = arr[i];
//                    gettingMinimumIndex = i;
//                }
//                if(arr[i] > checkingMaximumElement){
//                    checkingMaximumElement = arr[i];
//                    gettingMaximumIndex = i;
//                }
//            }
            int answerOne = (smallestIndex(arr) + 1), answerTwo = (getIndexOfMax(arr) + 1);
