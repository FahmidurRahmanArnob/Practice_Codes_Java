...
class AprilCookOff_FunnyHand {
    ...
    private static void solve() throws IOException {
        ...
        boolean checkerOne = maxValue - minValue > 2;
        boolean checkerTwo = maxValue - minValue <= 0;
        boolean checkerThree = minValue == 1;
        boolean checkerFour = maxValue == n;
        boolean checkerFive = maxValue - minValue == 2;
        if(checkerOne || checkerTwo){
            System.out.println(0);
        }
        else if(checkerThree || checkerFour || checkerFive){
